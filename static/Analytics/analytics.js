document.addEventListener("DOMContentLoaded", async () => {
	...
	// chart 5 total expenses per category
	const categoryAmountTotals = {};
	for (const e of expenses) {
		categoryAmountTotals[e.category] =
			(categoryAmountTotals[e.category] || 0) + Number(e.amount || 0);
	}
	const labels2 = Object.keys(categoryAmountTotals);
	const values2 = Object.values(categoryAmountTotals);
